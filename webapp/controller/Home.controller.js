    ...
    return Controller.extend('ui5.template.controller.Home', {
      onInit() {
        this.getView().setModel(new sap.ui.model.json.JSONModel({
          items: [
            { title: 'How many team members can I invite?', text: 'You can invite up to 2 additional users on the Free plan. There is no limit on team members for the Premium plan.' },
